...
print(f"Encrypted original values: {encrypted_values[0].ciphertext(), encrypted_values[1].ciphertext(), encrypted_values[2].ciphertext()}")
...
print(f"Encrypted sum with bonus: {encrypted_sum_with_bonus.ciphertext()}")
